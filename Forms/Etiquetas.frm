...
Begin VB.Form Etiquetas 
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CheckBox Check3 
         ...
         Width           =   2805
      End
      Begin MSMask.MaskEdBox txtEmp1 
         Height          =   285
         Left            =   3060
         TabIndex        =   31
         Top             =   120
         ...
         PromptChar      =   " "
      End
      Begin MSMask.MaskEdBox txtEmp2 
         Height          =   285
         Left            =   3060
         TabIndex        =   32
         Top             =   450
   ...
   Begin VB.Label Label15 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Emitir Etiquetas por Ordem de [C]odigo, [N]ome ou c[E]p.:"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   11.25
         Charset         =   0
...
Dim Etiquetas As Recordset 'Define Variavel Mailing
...
Set Etiquetas = db.OpenRecordset("Etiquetas")
...
'**********************************************
   ...
   While Not Mailing.EOF
       ...
       If Mailing!CODIGO >= Val(txtcod1.Text) And Mailing!CODIGO <= Val(txtcod2.Text) Then
          vcod = Mailing!CODIGO
          vnome = Mailing!EMPRESA
          vendereco = Mailing!ENDERECOcom
          vcep = Mailing!Cepcom
          ...
          Etiquetas!CODIGO = vcod
          Etiquetas!NOME = vnome
          Etiquetas!ENDERECOcom = Mid(vendereco, 1, 45)
          Etiquetas!Cepcom = vcep
          Etiquetas!CIDADEcom = vcidade
          Etiquetas!Uf = vuf
   ...
   CrystalReport1.ReportFileName = Repo8
...
Private Sub Label14_Click()
   ...
   While Not Mailing.EOF
       ...
       If Mailing!EMPRESA >= RTrim(txtCida1.Text) And Mailing!EMPRESA <= RTrim(txtCida2.Text) Then
          vcod = Mailing!CODIGO
          vnome = Mailing!EMPRESA
          vendereco = Mailing!ENDERECOcom
          vcep = Mailing!Cepcom
          ...
          Etiquetas!CODIGO = vcod
          Etiquetas!NOME = vnome
          Etiquetas!ENDERECOcom = vendereco
          Etiquetas!Cepcom = vcep
          Etiquetas!CIDADEcom = vcidade
...
Private Sub Label18_Click()
   ...
   Label13.Caption = "Aguarde Imprimindo!!!"
   Mailing.Index = "Cadcep"
   Mailing.MoveFirst
   
   While Not Mailing.EOF
   
       If Mailing!Cepcom >= txtEmp1.Text And Mailing!Cepcom <= txtEmp2.Text Then
          vcod = Mailing!CODIGO
          vnome = Mailing!EMPRESA
          vendereco = Mailing!ENDERECOcom
          vcep = Mailing!Cepcom
...
If txtEve1.Text <> " " Then
   'Gera Informações para Relatório
    ...
    Do While Not Eventos.EOF
       If Eventos!CODIGO >= txtEve1.Text Or Eventos!CODIGO <= txtEve2.Text Then
...
If txtLoc1.Text <> " " Then
   'Gera Informações para Relatório
    ...
    Do While Not LocaisEventos.EOF
       If LocaisEventos!CODIGO >= txtLoc1.Text Or LocaisEventos!CODIGO <= txtLoc2.Text Then
...
If txtMai1.Text <> " " Then
   'Gera Informações para Relatório
    ...
    Do While Not Mailing.EOF
       If Mailing!CODIGO >= txtMai1.Text Or Mailing!CODIGO <= txtMai2.Text Then
       
          Var_codigo = Mailing!CODIGO
          Var_empre = Mailing!EMPRESA
...
Private Sub txtConds_Change()
If txtConds.Text = "C" Then
   Picture1.Visible = True
   Picture2.Visible = False
   Picture3.Visible = False
   txtcod1.Text = RTrim(" ")
...
End Sub
Private Sub Atualiza_1()

   Etiquetas.MoveFirst
   While Not Etiquetas.EOF
      Etiquetas.Delete
      Etiquetas.MoveNext
   Wend
